      ...
      const onSubmit = async(data) => {
        try {
            ...
            const userData = {
                ...
                address: `${data.city || ''}, ${data.state || ''}, ${data.country || ''}, ${data.zipcode || ''}`
            };

            // Send registration data to backend using the public endpoint
            const response = await axios.post(`${getBaseUrl()}/api/auth/public-register`, userData);
            
            // Save token to localStorage if provided by the API
  ...
  return (
    ...
    <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='mb-4'>
                <label className='block text-gray-700 text-sm font-bold mb-2' htmlFor="phone">Phone (optional)</label>
                <input 
                {...register("phone")} 
            ...
            <div className='mb-4'>
                <label className='block text-gray-700 text-sm font-bold mb-2' htmlFor="city">City (optional)</label>
                <input 
                {...register("city")} 
